// src/components/waitlist/waitlistChatData.ts
import type { WaitlistChatData } from '@/types/waitlist'

export const waitlistChat: WaitlistChatData = {
  initial: [
    {
      type: 'assistant',
  ...
  questions: [
    ...
    {
      id: 'phone',
      question: "Pour terminer, quel est votre numéro de téléphone ? Format requis : +XXX XXXXXXXX (exemple : +221 77123456)",
      type: 'tel'
    }
  ],
